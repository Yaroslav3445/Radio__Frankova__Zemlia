        ...
        <>
            <div className={pageInfo.about}>
                ...
                <div className={pageInfo.about__wrapper}>
                    <div className={pageInfo.about__bild}>
                        <div className={pageInfo.about__image}> <img src={building} alt="building"/></div>
                        <div className={pageInfo.about__info}>
                            <h1>Франкова земля</h1>
                            <p>У січні 1990 року створено місцеве радіо «Франкова земля» під керівництвом Йосипа Фиштика.</p>
                            <p>У січні 1990 року створено місцеве радіо «Франкова земля» під керівництвом Йосипа Фиштика.</p>
                        </div>
                    </div>
                    <div className={pageInfo.about__person}>
                        <div className={pageInfo.about__downship}>
                            <p>
                        ...
                        <div className={pageInfo.about__portret}> <img src={person} alt="person" /></div>
                    </div>
                </div>
            </div>
        </>
